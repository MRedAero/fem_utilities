...
class CORD2S(object):
    ...
    def __init__(self, h5file):
        super(CORD2S, self).__init__()

        self.h5file = h5file

        self.data_group = self.h5file.add_bulk_data_group("CORD2S", "CORD2S Data Group")

        self.data_table = self.h5file.create_table(self.data_group, "CORD2S", self.DataTable, "CORD2S Data Table")
    ...
    def read_card(self, data):
        ...
        self.h5file.append_data(self.data_row, "COORD", "CORD2S", data[1])


card_readers['CORD2S'] = SingletonDecorator(CORD2S)