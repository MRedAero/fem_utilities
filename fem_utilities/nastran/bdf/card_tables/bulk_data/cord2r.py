...
class CORD2R(object):
    ...
    def __init__(self, h5file):
        super(CORD2R, self).__init__()

        self.h5file = h5file

        self.data_group = self.h5file.add_bulk_data_group("CORD2R", "CORD2R Data Group")

        self.data_table = self.h5file.create_table(self.data_group, "CORD2R", self.DataTable, "CORD2R Data Table")
    ...
    def read_card(self, data):
        ...
        self.h5file.append_data(self.data_row, "COORD", "CORD2R", data[1])


card_readers['CORD2R'] = SingletonDecorator(CORD2R)